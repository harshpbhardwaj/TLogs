...
class Login(models.Model):
    ...
    verified = models.CharField(blank=True, default=0, null=True)
    verification_key = models.CharField(blank=True, max_length=122, null=True)
    verification_key_datetime = models.DateTimeField(blank=True, null=True)
